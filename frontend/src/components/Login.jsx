...
const Login = ({onLoginSuccess = null}) => {
  ...
  const handleSubmit = async (ev) => {
    ...
    try {
        ...
        if (data?.token) {
            // FIXED: "authToken" (matching Navbar) instead of "authtoken"
            ...
            // This triggers the Navbar to switch from 'Login' to 'Logout' immediately
                    ...
                    <div className={loginStyles.animatedBorder}>
                        <div className={loginStyles.formContent}>
                            ...
                            <p className={loginStyles.subtitle}>
                                Sign in to continue to StudyNP Quiz. Light, clean UI - smooth 
                            ...
                            {submitError && <p className={loginStyles.submitErrorText}>{submitError}</p>}
